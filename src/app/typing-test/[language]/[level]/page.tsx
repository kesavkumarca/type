        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl">
            ...
            <textarea
              ...
              className={`w-full h-72 p-4 bg-black/30 border border-white/5 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none resize-none text-white text-lg disabled:opacity-50 disabled:cursor-not-allowed ${language === 'tamil' ? 'tamil-text' : 'font-serif'}`}
